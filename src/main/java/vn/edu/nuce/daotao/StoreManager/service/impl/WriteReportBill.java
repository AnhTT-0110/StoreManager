...
@Log4j2
public class WriteReportBill {

    public static final int COLUMN_INDEX_ID = 0;
    public static final int COLUMN_INDEX_CUSTOMERCODE = 1;
    public static final int COLUMN_INDEX_CUSTOMER_NAME = 2;
...
//            System.out.println("FIELD: " + excelFilePath+dtf.format(now)+".xlsx");
    ...
    private static void writeHeader(Sheet sheet, int rowIndex) {
        ...
        cell = row.createCell(COLUMN_INDEX_CUSTOMERCODE);
        cell.setCellStyle(cellStyle);
